...
public interface ICarService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICarService {
        ...
        static final int TRANSACTION_setEqIdx = 20;
        static final int TRANSACTION_getEqIdx = 21;
        static final int TRANSACTION_setLud = 22;
        static final int TRANSACTION_getLud = 23;
        ...
        private static class Proxy implements ICarService {
            ...
            public void setEqIdx(int idx) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getEqIdx() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setLud(boolean on) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public int getLud() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_putDataChanage /*19*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setEqIdx /*20*/:
                    data.enforceInterface(DESCRIPTOR);
                    setEqIdx(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getEqIdx /*21*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getEqIdx();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setLud /*22*/:
                    data.enforceInterface(DESCRIPTOR);
                    setLud(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getLud /*23*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getLud();
                    reply.writeNoException();
                    reply.writeInt(_result);
    ...
    int getEqIdx() throws RemoteException;

    int getLud() throws RemoteException;
    ...
    void setEqIdx(int i) throws RemoteException;

    void setLud(boolean z) throws RemoteException;
